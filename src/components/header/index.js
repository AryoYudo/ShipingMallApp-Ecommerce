            ...
            <div className="header">
                <div className="container">
                    <div className="row align-items-center justify-content-center">
                        <div className="align-items-center part-2">
                            <div className="logo-wrapper col-sm-1 me-2">
